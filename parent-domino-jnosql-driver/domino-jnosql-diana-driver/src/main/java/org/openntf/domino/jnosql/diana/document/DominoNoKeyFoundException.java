...
/**
 * An exception when {@link DominoDocumentCollectionManager} tries to both
 * update and insert, but it does not found The column with the name "_id".
 */
public class DominoNoKeyFoundException extends RuntimeException {
	private static final long serialVersionUID = 1L;

	DominoNoKeyFoundException(String message) {
