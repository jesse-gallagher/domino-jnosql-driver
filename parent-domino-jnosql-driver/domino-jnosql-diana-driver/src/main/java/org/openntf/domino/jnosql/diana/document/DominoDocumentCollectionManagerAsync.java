 ...
 */
public interface DominoDocumentCollectionManagerAsync extends DocumentCollectionManagerAsync {
	/**
     ...
     */
    void query(String query, Map<String, Object> params, Consumer<List<DocumentEntity>> callback) throws ExecuteAsyncQueryException;
